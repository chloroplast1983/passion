...
<!--content-->
		<div class="content">
			<div class="site_navigation">
				<span>You are here:</span><a href="/">Home</a>><span>About</span>
			</div>
			<!--About-->
			<div class="product_details about_main">
				<!-- Nav tabs -->
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#about_passion" aria-controls="home" role="tab" data-toggle="tab">About Passion</a></li>
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="about_passion">
						<h2><img src="./Global/Style/Home/images/logo.png">&nbsp;&nbsp;XI'AN Passion Elevator Parts Co.,Ltd</h2>
						<p>Passion，a professional manufacture and supplier for elevator and escalator spare parts. 10 years Professional Experience，specialized in wholesaling elevator parts and escalator spare parts for many years, we have maintained good business relationships with majority elevator and escalator parts manufacturers in domestic market. We supply the original or A class components (A+, A, A-class).We are always dedicated to provide quality product  and thoughtful customer service. Taking ""providing most-effective products"" as the company core value.</p>
						<p>Passion has been supplying our products to more than 100 countries all over the world, such as Asia, Europe, America, oceania, etc. Passion has been appointed as long-term global supplier of OTIS, KONE and ThyssenKrupp elevator companies.</p>
						<p>Our commitment：To provide customers with the best quality，the most reasonable price and the most delicated service. Your satisfaction is our greatest pursuit。</p>
