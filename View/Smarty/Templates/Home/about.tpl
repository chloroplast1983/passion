			...
			<div class="product_details about_main">
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane active" id="about_passion">
						...
						<p><strong>Kevin Systrom (CEO, co-founder)</strong></p>

						<p><strong>Kevin Systrom</strong> (<a href="https://www.instagram.com/kevin/">@kevin</a>) is the CEO and co-founder of Instagram, a community of more than 500 million who capture and share the world's moments on the service. He is responsible for the company's overall vision and strategy as well as day-to-day operations.</p>
						...
						<p><strong>Mike Krieger (CTO, co-founder)</strong></p>

						<p><strong>Mike Krieger</strong> (<a href="https://www.instagram.com/mikeyk/">@mikeyk</a>) is the CTO and co-founder of Instagram, a global community that shares more than 95 million photos every day. As the head of engineering, Mike focuses on building products that bring out the creativity in all of us.</p>
